...
"""
import sys
sys.path.append('/Users/wenninger/OneDrive - Nexus365/PhD_Oxford/Python/Python_Scripts/QMix/QMix-master')
...
class RawData(object):
    ...
    def plot_error_surface(self, fig_name=None, ax=None):  # pragma: no cover
        ...
        zt_real = np.linspace(remb_range[0], remb_range[1], 5001) * self.rn #Edited Jakob 2019/12/16
        zt_imag = np.linspace(xemb_range[0], xemb_range[1], 10001) * self.rn #Edited Jakob 2019/12/16
